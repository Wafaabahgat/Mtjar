  ...
  return (
    <div className="fixed left-0 top-0 w-full z-10 shadow-xl">
      <div className="max-w-[1740px] m-auto flex justify-between items-center p-3 bg-green-300">
        ...
        <div className="hidden sm:block absolute top-0 mt-[65px] right-0 left-0 w-full h-screen text-center">
          <ul className="  ">
            <li className="p-5">Dashboard</li>
            <li className="p-5">Home</li>
            <li className="p-5">Products</li>
            <li className="p-5"> cart</li>
            <li className="p-5 ">
              <AiOutlineShoppingCart className="text-3xl border p-1 rounded-full border-black absolute right-0 left-0 w-full h-screen text-center" />
            </li>
          </ul>
        </div>
        {/* Profile */}
