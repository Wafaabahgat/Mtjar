      ...
      <div className="flex flex-col items-center justify-center w-full flex-1 px-20">
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl flex w-2/3 md:w-5/6">
          ...
          <div className="w-2/5 bg-green-500 rounded-tl-2xl rounded-bl-2xl py-32 px-12">
            <h2 className="text-white text-3xl font-bold mb-2 lg:text-xl md:text-xl ">
              Hello,Friend!
            </h2>
            <span className="border-2 w-10 inline-block mb-3 mb:w-8"></span>
          ...
          <div className="w-3/5 p-5">
            ...
            <div className="py-10 ">
              <h2 className="text-green-500 font-bold text-3xl mt-2 lg:text-2xl ">
                Sign up to Account
              </h2>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex justify-between w-64 my-3 text-green-500">
