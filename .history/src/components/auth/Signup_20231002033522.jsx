  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full flex-1 px-20">
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl flex w-2/3 md:w-5/6">
          {/* signUp */}
          <div className="w-2/5 bg-green-500 rounded-tl-2xl rounded-bl-2xl py-32 px-12">
            ...
            <button className="border-2 px-10 py-2 lg:px-5 md:px-2 rounded-full text-white font-bold mt-4 hover:bg-white hover:text-green-500">
          ...
          <div className="w-3/5 p-5">
            ...
            <div className="py-10 ">
              ...
              <div className="flex flex-col items-center">
                <form className="bg-gray-200 w-64 md:w-60 md:p-2 flex items-center p-3 mb-3 ">
                  <MdDriveFileRenameOutline className="mr-3 text-gray-400 md:text-5xl" />
                  <input
                    placeholder="Name"
                    type="name"
                    name="name"
                ...
                <div className="flex justify-between w-64 md:w-60 my-3 text-green-500">
                  <Link to="/login">Already have an acc?</Link>
                </div>
                <button className="border-2 px-10 py-2 md:px-7 rounded-full text-white font-bold mt-4 bg-green-500 hover:bg-white hover:text-green-500">
