      ...
      <div className="flex flex-col items-center justify-center w-full flex-1 px-20">
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl flex w-2/3 ">
          ...
          <div className="w-2/5 lg:w-3/5 bg-green-500 rounded-tl-2xl rounded-bl-2xl py-32 px-12">
            ...
            <button className="border-2 px-10 py-2 lg:px-8 rounded-full text-white font-bold mt-4 hover:bg-white hover:text-green-500">
              <Link to="/login"> Sign in</Link>
            </button>
          </div>
          {/* Signup */}
          <div className="w-3/5 p-5">
            <div className="font-bold text-right lg:text-sm lg:mr-10">
              <span className="text-green-500 ">Company</span>Name
            </div>
            <div className="py-10 ">
              <h2 className="text-green-500 font-bold text-3xl mt-2 lg:text-xl lg:mr-6">
                Sign up to Account
              </h2>
