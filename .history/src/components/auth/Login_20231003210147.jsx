...
const Login = () => {
  return (
    <>
      <div className="flex flex-col w-full flex-1 px-20 bg-gray-600 ">
        <div className="bg-white rounded-2xl shadow-2xl flex flex-row max-w-[800px] items-center justify-center ">
          {/* SignIn */}
