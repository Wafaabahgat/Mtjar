...
const Login = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full flex-1 px-20 shadow-2xl bg-gray-100">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl flex w-2/3">
        {/* SignIn */}
        <div className="w-3/5 p-5">
            <div>
                <div className="font-bold "><span className="text-green-500 ">Company</span>Name</div>
            </div>
        </div>
