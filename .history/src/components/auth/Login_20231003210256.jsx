...
const Login = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full flex-1 px-20 bg-gray-600 ">
        <div className="bg-white rounded-2xl shadow-2xl flex flex-row max-w-[800px] ml-40">
          {/* SignIn */}
          <div className="w-3/5 p-5 md:w-4/5 items-center justify-center">
