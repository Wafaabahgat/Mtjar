          ...
          <div className="w-3/5 p-5">
            ...
            <div className="py-10 ">
              ...
              <div className="flex flex-col items-center">
                <form className="bg-gray-200 w-64 flex items-center p-3 mb-3 lg:w-60">
                  <FaRegEnvelope className="mr-3 text-gray-400 lg:mr-4" />
                  <input
                    placeholder="Email"
                    type="email"
                    name="email"
                ...
                <form className="bg-gray-200 w-64 flex items-center p-3 lg:w-60">
