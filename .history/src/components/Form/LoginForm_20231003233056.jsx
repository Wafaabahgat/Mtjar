  ...
  return (
    <div>
      <form className="bg-gray-200 w-64 flex items-center p-3 lg:w-61">
        ...
        <FormInput type="email" name="email" placeholder="Email" className="outline-none bg-gray-200 "/>
      </form>
      <form className="bg-gray-200 w-64 flex items-center p-3 lg:w-61">
        <MdLockOutline className="mr-3 text-gray-400 " />
        <FormInput type="password" name="password"  placeholder="Password" className="outline-none bg-gray-200 "/>
        <input
