        ...
        <div
          className={
            nav
              ...
              : "hidden sm:block absolute top-0 mt-[65px] right-0 left-[-100%] w-full h-screen text-center"
          }
        >
          <ul > 
            <li className="p-5 text-xl">Dashboard</li>
            <li className="p-5 text-xl shadow-">Home</li>
            <li className="p-5 text-xl shadow-">Products</li>
            <li className="p-5 text-xl shadow-">Cart</li>
            <li className="p-5 text-xl shadow- ">
