...
// *********** globalCategories *********** //
export const globalCategories = createAsyncThunk("globals/all", async (args, thunkAPI) => {
...
export const globalStores = createAsyncThunk("globals/all", async (args, thunkAPI) => {
  const { rejectWithValue } = thunkAPI;
  try {
